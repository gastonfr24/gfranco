...
function Information() {
  return (
    ...
    bg-gray-100 sm:rounded-lg">
        <div className="p-12">
      <h1 className="text-2xl sm:text-3xl text-gray-100 font-bold tracking-tight">
      ¿Quieres cotizar un proyecto?
      </h1>
      <p className="text-normal text-base font-medium text-gray-400  mt-5">
      Enviar una cotización es el primer paso hacia la realización de tu visión digital.
      </p>
      <p className="text-normal text-base font-medium text-gray-400  my-5">
