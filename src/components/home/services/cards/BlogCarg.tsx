...
function BlogCard() {
  return (
    ...
    <div className="flex flex-col items-start justify-center gap-4 p-4 m-4 lg:m-0 lg:ml-10 lg:w-[95%]">
      <h2 className="lg:text-2xl font-semibold text-lime-400 dark:text-lime-300">Blog Profesional<br/>
      <span className="lg:block hidden italic text-gray-300 dark:text-gray-500 font-semibold text-sm ml-6 text-right">empresarial o personal</span>
      </h2>
      ...
      <Link href="/contact" className="mt-4 bg-lime-300 px-5 py-2 text-graydark font-bold shadow-xl transition-all duration-300 hover:bg-lime-400">
        Saber más
      </Link>
