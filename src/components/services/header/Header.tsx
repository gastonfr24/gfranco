...
function Header() {
  return (
    <div className='h-screen w-auto lg:flex lg:pt-20 my-auto pb-20 lg:pb-0 text-gray-100 text-center lg:text-left'>
        <div className="lg:my-auto lg:w-5/12 pt-40 lg:pt-0">

  <h1 className="text-[40px] lg:text-[45px] xl:text-[55px] font-bold leading-tight mt-5 sm:mt-0 text-skyblue-100">
    Servicios de Desarrollo Web
  </h1>
<p className="mt-5 lg:text-lg text-gray-200">
